                ...
                {settingsTab === "supabase" && (
                  <section className="settings-tab-panel">
                    ...
                    <div className="security-note">
                      <strong>Restaurer ou reconnecter un espace MailDesk</strong>
                      <span>Ouvre l’assistant de connexion utilisateur Supabase pour rapatrier un espace existant sur ce PC sans utiliser de clé service_role.</span>
                      <div className="supabase-actions"><button type="button" className="primary-outline" onClick={() => void window.maildesk?.openWorkspaceSetup()}>Reconnecter / restaurer un espace</button></div>
                    </div>
